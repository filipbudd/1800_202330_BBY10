        ...
        if (user) {
            ...
            currentUser.get()
                .then(userDoc => {
                    ...
                    //This is done so skibidi toilet that I'm actually astounded that this works
                    ...
                    if (userBio != null) {
                        ...
                        updateCharCount(); // Call the function to update character count on page load
                    }
                    if (userCity != null) {
...
function updateCharCount() {
    ...
    if (bioInputValue.length > characterLimit) {
        ...
        bioInputValue = document.getElementById('bioInput').value; // Update the value after truncation
    }
